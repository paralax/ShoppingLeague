...
// Script information
$script_info = 'phpMyAdmin 2.11.10 setup script by Michal Čihař <michal@cihar.com>';
$script_version = '$Id$';
...
<head>
    ...
    <title>phpMyAdmin 2.11.10 setup</title>
    ...
    div.notice {
        ...
        background-image: url(http://eros.eas.gatech.edu/phpMyAdmin/themes/original/img/s_notice.png);
    ...
    div.warning {
        ...
        background-image: url(http://eros.eas.gatech.edu/phpMyAdmin/themes/original/img/s_warn.png);
        background-repeat: no-repeat;
        background-position: 10px 50%;
        padding: 10px 10px 10px 36px;
    }
    ...
    div.error {
        ...
        background-image: url(http://eros.eas.gatech.edu/phpMyAdmin/themes/original/img/s_error.png);
        background-repeat: no-repeat;
        background-position: 10px 50%;
        padding: 10px 10px 10px 36px;
    }
...
<body>
<h1>phpMyAdmin 2.11.10 setup</h1>
<?php
...
function get_cfg_doc($anchor) {
    ...
    return
        ...
        '<img class="icon" src="http://eros.eas.gatech.edu/phpMyAdmin/themes/original/img/b_help.png" width="11" height="11" alt="Documentation" title="Documentation" />' .
        '</a>' .
        '<a href="http://wiki.phpmyadmin.net/pma/Config#' . $wiki . '" target="pma_doc" class="doc">' .
        '<img class="icon" src="http://eros.eas.gatech.edu/phpMyAdmin/themes/original/img/b_info.png" width="11" height="11" alt="Wiki" title="Wiki" />' .
        '</a>' .
        '</span>'
        ;
}
